...
class Lib
{
    ...
    11: Pengurus
		...
		51: Staf Umum
		52: Kasie Umum
		51: Kepala Divisi Operasional dan SDI
		99: Administrator
		*/
		...
		if (($class == "aset") && ($function == "aktif")) {
			$access = array(41, 42, 51, 52, 53, 99);
			...
			$access = array(41, 42, 51, 52, 53, 99);
		} else if (($class == "aset") && ($function == "cetak-label")) {
			$access = array(51, 52, 53, 99);
		} else if (($class == "aset") && ($function == "get-data-cetak-label")) {
			$access = array(51, 52, 53, 99);
		} else if (($class == "aset") && ($function == "cetak-label-aksi")) {
			$access = array(51, 52, 53, 99);
		}
