          ...
          <div class="section-body">
            <div class="row">
              <div class="col-12 col-md-12 col-lg-12">
                <div class="card">
                  <form class="needs-validation" novalidate="" action="<?= base_url() ?>core-aset/terima_permohonan_perbaikan_pusat" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                      ...
                      <div class="form-group mb-1">
                        <label>Biaya Final Perbaikan Pusat</label>
                        <input type="number" name="final_biaya_pusat" class="form-control" id="biaya" required="">
                        <div class="invalid-feedback">
                          Biaya Final Perbaikan Pusat harus diisi
                        </div>
                      </div>
                      <div class="form-group mb-1">
