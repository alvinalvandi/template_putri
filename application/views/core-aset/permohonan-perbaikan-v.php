...
<body>
      ...
      <div class="main-content">
        <section class="section">
          <div class="section-header">
            <h1>Data Permohonan Perbaikan</h1>
            <div class="section-header-breadcrumb">
              ...
              ?>
                <a href="<?= base_url() ?>core-aset/add-permohonan_perbaikan" class="btn btn-icon icon-left btn-primary"><i class="fas fa-plus-circle"></i> Tambah</a>
              <?php
              }
              ?>
  ...
  <script type="text/javascript">
    ...
    table = $("#table-1").DataTable({
      ...
      "order": [],
      "ajax": {
        "url": "<?php echo base_url() ?>core-aset/get-data-permohonan-perbaikan",
        "type": "POST"
      },
      "ordering": false,
    ...
    function hapus(id) {
      swal({
        ...
        .then((willDeleted) => {
          if (willDeleted) {
            $.ajax({
              url: "<?= base_url() ?>core-aset/delete-permohonan-perbaikan",
              type: "POST",
              data: {
                id_permohonan_perbaikan: id,
                action_method: "hapus",
              },
              dataType: "JSON",
    ...
    function tolak(id) {
      swal({
        ...
        .then((willDeleted) => {
          if (willDeleted) {
            $.ajax({
              url: "<?= base_url() ?>core-aset/tolak-permohonan-perbaikan",
              type: "POST",
              data: {
                id_permohonan_perbaikan: id,
                action_method: "tolak",
