...
<head>
  ...
  <link rel="shortcut icon" sizes="196x196" href="<?=base_url()?>assets/img/logo-only.png">
  <title>SIMIA &mdash; Bank Mustaqim Aceh</title>
  <!-- General CSS Files -->
...
<style>
  @media print {
    ...
    /* @page {size: F4 landscape;max-height:100%; max-width:100%} */
  }
</style>
                    ...
                    <div class="row">
                      ...
                      <div class="col-lg-5 col-md-6 order-sm-3 order-md-2 order-col-lg-2">
                        ...
                        <div class="row">
                          ...
                          <div class="col-8">
                            <label>Rp. <?= number_format($harga_perolehan,0,',','.'); ?></label>
                          </div>
                        </div>
                        <div class="row">
                          <div class="col-4">
