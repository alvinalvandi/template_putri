...
<body>
  ...
  <script type="text/javascript">
    ...
    table = $("#table-1").DataTable({
      ...
      "order": [], 
      "ajax": {
        "url": "<?php echo base_url()?>master/get-data-jenis",
        "type": "POST"
      },
      "ordering": false,
    ...
    function ubah(id) {
      ...
      $.ajax({
        url : "<?=base_url()?>master/get-jenis/"+id,
        type: "GET",
        dataType: "JSON",
        success: function(data) {
          $('input[name="id_jenis"]').val(data.idjenis);
    ...
    $('#form-aksi').submit(function(event) {
      ...
      if ($('#form-aksi')[0].checkValidity() === false) {
        ...
        $.ajax({
          url : "<?=base_url()?>master/jenis-aksi",
          type: "POST",
          data: {
            id_jenis: $('input[name="id_jenis"]').val(),
