...
<body>
  ...
  <script type="text/javascript">
    ...
    table = $("#table-1").DataTable({
      ...
      "order": [], 
      "ajax": {
        "url": "<?php echo base_url()?>master/get-data-kategori",
        "type": "POST"
      },
      "ordering": false,
    ...
    function ubah(id) {
      ...
      $.ajax({
        url : "<?=base_url()?>master/get-kategori/"+id,
        type: "GET",
        dataType: "JSON",
        success: function(data) {
          $('input[name="id_kategori"]').val(data.idkategori);
    ...
    $('#form-aksi').submit(function(event) {
      ...
      if ($('#form-aksi')[0].checkValidity() === false) {
        ...
        $.ajax({
          url : "<?=base_url()?>master/kategori-aksi",
          type: "POST",
          data: {
